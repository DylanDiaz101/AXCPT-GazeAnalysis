# This is the ALL TRIALS version of the analysis program.
# Condition for ACC is not included here.
...
for file in csv_files:
    ...
    # read csv file
    df = pd.read_csv(file, delimiter="\t")  # delimiter indicates gazedata has tab separated values
